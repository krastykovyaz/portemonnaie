...
export default defineConfig({
  // The Lovable default is cloudflare-module, which has no persistent
  // filesystem for the sql.js database. Build a plain Node server instead so
  // production can run the built output rather than `vite dev`.
